...
class FileUtil {
  ...
  static property get AppFolder() : String {
    return System.getProperty("user.dir").replaceAll("\\\\", "/").concat("/src/main/gosu/")
  }
  ...
  static property get ConfigurationFolder() : String {
    return PropertyReaderUtil.getProperty("codeinspect.project.location").concat("/modules/configuration")
  }
